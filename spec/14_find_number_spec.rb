...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min is 5 and max is 9' do
      ...
      it 'returns 7' do
        expect(game_five_nine.make_guess).to eql(7)
      end
    end
    ...
    context 'when min is 8 and max is 9' do
      ...
      it 'returns 8' do
        expect(game_eight_nine.make_guess).to eql(8)
      end
    end
    ...
    context 'when min is 0 and max is 3' do
      ...
      it 'returns 1' do
        expect(game_zero_three.make_guess).to eql(1)
      end
    end
    ...
    context 'when min and max both equal 3' do
      ...
      it 'returns 3' do
        expect(game_three_three.make_guess).to eql(3)
      end
    end
  end
  ...
  describe '#game_over?' do
    context 'when guess and random_number are equal' do
      ...
      subject(:game_over) { described_class.new(0, 4, correct_guess, 2) }
      # Allow the double to receive 'value' and return the same number as @guess.
      let(:correct_guess) { double('random_number', value: 2) }
    ...
    context 'when guess and random_number are not equal' do
      let(:incorrect_guess) { double('random_number', value: 5) }
      subject(:game_not_over) { described_class.new(0, 4, incorrect_guess, 1) }
